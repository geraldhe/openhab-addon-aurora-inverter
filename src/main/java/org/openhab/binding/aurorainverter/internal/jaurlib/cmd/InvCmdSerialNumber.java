 ...
 */
public class InvCmdSerialNumber extends InverterCommand {
    public InvCmdSerialNumber(int aInverterAddress) {
    ...
    public AuroraResponse execute(AuroraDriver auroraDriver) {
        ...
        try {
            auroraResponse = auroraDriver.acquireSerialNumber(address);
        } catch (Exception e) {
